      ...
      <div className="container qmWrap">
        ...
        <ul className="aboutList">
          <li className="aboutItem">
            ...
            <p className="aboutItemText">We develop innovative products, systems and services</p>
          </li>
          <li className="aboutItem">
            <span className="aboutItemSpan">02</span>
            <p className="aboutItemText">Next we build teams to scale them into companies</p>
          </li>
          <li className="aboutItem">
            <span className="aboutItemSpan">03</span>
            <p className="aboutItemText">Each startup solving one problem at a time</p>
          </li>
        </ul>
      </div>
    </section>
